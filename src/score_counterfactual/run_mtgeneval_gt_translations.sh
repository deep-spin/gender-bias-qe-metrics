...
BASE_OUTPUT_DIR="$ROOT_DIR/results/scores/nonambiguous-counterfactual/mtgeneval/gt-translations"
GT_TRANSLATIONS_DIR="$ROOT_DIR/data/mtgeneval/google_translated_counterfactual/"
...
for lang in "${LANGS[@]}"; do
    ...
    for model_name in "${!MODELS[@]}"; do
        ...
        python src/score_counterfactual/score_gt_translations.py \
            --qe_metric_name_or_path "$model_id" \
            --translations_dir "$GT_TRANSLATIONS_DIR" \
