...
def get_args():
    ...
    parser.add_argument("--output_dir", type=str,  help="Output directory",default="./results/scores/ambiguous/gate")
...
def read_gate_dataset(lang: str):
    #TODO: replace with gate dataset
    dataset_name = "....."
    ...
    return data,m_input,f_input


def run_metric(model_name: str, g_input: List[Dict], n_input: List[Dict]):
    #TODO: replace with gate dataset and do the correct naming of variables below (male, female, neutral)
...
def main(args):
    ...
    # read dataset
    data = read_gate_dataset(args.tgt_lang)
